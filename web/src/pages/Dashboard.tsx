...
export function Dashboard() {
  ...
  if ((planner.overdue || 0) > 0) priorities.push({ title: 'Aufgaben überfällig', detail: `${planner.dueToday || 0} weitere Aufgaben sind heute fällig.`, value: planner.overdue || 0, tone: 'warning', href: config?.plannerUrl || '#' });
    ...
    <div className="suite-dashboard">
      ...
      <section>
        ...
        <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
          ...
          <CoreCard icon={Kanban} name="PlannerCore" eyebrow="Aufgaben & Planung" color="var(--accent-red)" href={config?.plannerUrl || '#'} metrics={[`${planner.openTasks || 0} offene Aufgaben`, `${planner.overdue || 0} überfällig · ${planner.dueToday || 0} heute`]} error={planner.error} />
